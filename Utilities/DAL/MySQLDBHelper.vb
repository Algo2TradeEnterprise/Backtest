...
#Region "Constructor"
        Public Sub New(ByVal serverName As String,
            ...
            _connectionString = String.Format("Server={0};Database={1};Port={2};Uid={3};Pwd={4};default command timeout=1800;Pooling=True;Min Pool Size=2;Max Pool Size=5;UseAffectedRows=false;Allow User Variables=True", _serverName, _dbName, _port, _userID, _password)
        End Sub
#End Region
