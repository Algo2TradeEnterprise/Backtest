...
Namespace StrategyHelper
    Public Class GenericStrategy
        ...
        Public Overrides Async Function TestStrategyAsync(startDate As Date, endDate As Date) As Task
            ...
            End If
            Dim filename As String = String.Format("TF {0},MP {1},ML {2},Capital {3},Number Of Stock {4}",
                                                   Me.SignalTimeFrame,
            ...
            Else
                ...
                While tradeCheckingDate <= endDate.Date
                    ...
                    Dim stockList As Dictionary(Of String, Decimal()) = GetStockData(tradeCheckingDate)
                            ...
                            If XDayOneMinutePayload IsNot Nothing AndAlso XDayOneMinutePayload.Count > 0 Then
                                ...
                                If currentDayOneMinutePayload IsNot Nothing AndAlso currentDayOneMinutePayload.Count > 0 Then
                                    ...
                                    Select Case RuleNumber
                                        Case 0
                                            stockRule = New SmallestCandleBreakoutStrategyRule(XDayOneMinutePayload, stockList(stock)(0), Me, tradeCheckingDate, tradingSymbol, _canceller)
                                        Case 1
