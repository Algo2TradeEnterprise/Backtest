                    ...
                    If stockList IsNot Nothing AndAlso stockList.Count > 0 Then
                        ...
                        For Each stock In stockList.Keys
                            ...
                            If Me.DataSource = SourceOfData.Database Then
                                XDayOneMinutePayload = Cmn.GetRawPayload(Me.DatabaseTable, stock, tradeCheckingDate.AddDays(-10), tradeCheckingDate)
                            ...
                            If XDayOneMinutePayload IsNot Nothing AndAlso XDayOneMinutePayload.Count > 0 Then
                                ...
                                If currentDayOneMinutePayload IsNot Nothing AndAlso currentDayOneMinutePayload.Count > 0 Then
                                    ...
                                    stockRule = New SachinPatelStrategyRule(XDayOneMinutePayload, stockList(stock).LotSize, Me, tradeCheckingDate, tradingSymbol, _canceller, RuleEntityData)
            ...
            If Me.StockFileName IsNot Nothing Then
                ...
                If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                    ...
                    For i = 1 To dt.Rows.Count - 1
                        ...
                        Dim instrumentName As String = dt.Rows(i).Item(2)
