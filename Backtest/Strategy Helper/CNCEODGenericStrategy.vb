                    ...
                    If stockList IsNot Nothing AndAlso stockList.Count > 0 Then
                        ...
                        For Each stock In stockList.Keys
                            ...
                            If Me.DataSource = SourceOfData.Database Then
                                XDayPayload = Cmn.GetRawPayload(Common.DataBaseTable.EOD_POSITIONAL, stock, tradeCheckingDate.AddYears(-3), tradeCheckingDate)
                            ElseIf Me.DataSource = SourceOfData.Live Then
                                XDayPayload = Await Cmn.GetHistoricalDataAsync(Me.DatabaseTable, stock, tradeCheckingDate.AddYears(-3), tradeCheckingDate).ConfigureAwait(False)
                            End If
