        ...
        Public Overridable Sub PrintArrayToExcel(ByVal fileName As String, Optional ByVal tradesFilename As String = Nothing, Optional ByVal capitalFileName As String = Nothing)
            For retryCounter As Integer = 1 To 20 Step 1
                Try
                    ...
                    If tradesFilename IsNot Nothing AndAlso capitalFileName IsNot Nothing AndAlso
                        File.Exists(tradesFilename) AndAlso File.Exists(capitalFileName) Then
                    ...
                    Else
                        allTradesData = _TradesTaken
                        allCapitalData = _CapitalMovement
                    End If
