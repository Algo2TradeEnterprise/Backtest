...
#End Region
    ...
    Public Overrides Async Function IsTriggerReceivedForPlaceOrderAsync(currentTick As Payload) As Task(Of Tuple(Of Boolean, List(Of PlaceOrderParameters)))
        ...
        If currentDayCandlePayload IsNot Nothing AndAlso currentDayCandlePayload.PreviousCandlePayload IsNot Nothing Then
            Dim signals As List(Of Tuple(Of Boolean, Decimal, Integer, Integer, String)) = GetSignalForEntry(currentDayCandlePayload)
    ...
    Private Function GetSignalForEntry(ByVal candle As Payload) As List(Of Tuple(Of Boolean, Decimal, Integer, Integer, String))
        Dim ret As List(Of Tuple(Of Boolean, Decimal, Integer, Integer, String)) = Nothing
        ...
        If candle.Low < candle.PreviousCandlePayload.Low Then
            Dim entryPrice As Decimal = candle.PreviousCandlePayload.Low
            ...
            If lastTrade Is Nothing Then
                ...
                ret.Add(New Tuple(Of Boolean, Decimal, Integer, Integer, String)(True, entryPrice, quantity, iteration, "First Trade"))
            Else
                If entryPrice < lastTrade.EntryPrice Then
                    If lastTrade.EntryPrice - entryPrice >= atr Then
                        ...
                        If ret Is Nothing Then ret = New List(Of Tuple(Of Boolean, Decimal, Integer, Integer, String))
                        ret.Add(New Tuple(Of Boolean, Decimal, Integer, Integer, String)(True, entryPrice, quantity, iteration, "Below last entry"))
                    End If
                Else
                    If ret Is Nothing Then ret = New List(Of Tuple(Of Boolean, Decimal, Integer, Integer, String))
                    ret.Add(New Tuple(Of Boolean, Decimal, Integer, Integer, String)(True, entryPrice, quantity, iteration, "(Reset) Above last entry"))
                End If
            End If
