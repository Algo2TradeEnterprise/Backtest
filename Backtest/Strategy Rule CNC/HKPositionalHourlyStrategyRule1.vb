...
Public Class HKPositionalHourlyStrategyRule1
...
#End Region
    ...
    Public Overrides Sub CompletePreProcessing()
        ...
        Dim eodPayload As Dictionary(Of Date, Payload) = Me._parentStrategy.Cmn.GetRawPayload(Common.DataBaseTable.EOD_POSITIONAL, _tradingSymbol, _tradingDate.AddYears(-10), _tradingDate)
