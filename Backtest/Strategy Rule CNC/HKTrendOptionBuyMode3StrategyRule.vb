...
Public Class HKTrendOptionBuyMode3StrategyRule
...
#End Region
    ...
    Private _hkTrendPayload As Dictionary(Of Date, Color) = Nothing
    ...
    Public Overrides Sub CompletePreProcessing()
        ...
        _hkTrendPayload.Remove(_currentDayCandle.PayloadDate)
...
#Region "Entry Signal Check"
    Private Function IsEntrySignalReceived(ByVal currentTickTime As Date) As Tuple(Of Boolean, Payload, Trade.TradeExecutionDirection)
        ...
        If Not _ParentStrategy.IsTradeActive(GetCurrentTick(_TradingSymbol, currentTickTime), Trade.TypeOfTrade.CNC) Then
            If _hkTrendPayload IsNot Nothing AndAlso _hkTrendPayload.Count > 0 Then
                Dim trend As Color = _hkTrendPayload.LastOrDefault.Value
                Dim previousTrend As Color = _hkTrendPayload(_eodPayload.LastOrDefault.Value.PreviousCandlePayload.PayloadDate)
    ...
    Private Function GetRolloverDay(ByVal currentTrend As Color) As Date
        ...
        For Each runningPayload In _eodPayload.OrderByDescending(Function(x)
            ...
            If runningPayload.Value.PreviousCandlePayload IsNot Nothing AndAlso
                ...
                Dim trend As Color = _hkTrendPayload(runningPayload.Value.PreviousCandlePayload.PayloadDate)
