...
Public Class RSIContinuesStrategyRule
...
#End Region
    ...
    Public Overrides Sub CompletePreProcessing()
        ...
        Indicator.RSI.CalculateRSI(2, _signalPayload, _rsiPayloads)
    End Sub
    ...
    Public Overrides Async Function IsTriggerReceivedForPlaceOrderAsync(currentTick As Payload) As Task(Of Tuple(Of Boolean, List(Of PlaceOrderParameters)))
        ...
        If currentMinuteCandlePayload IsNot Nothing AndAlso currentMinuteCandlePayload.PreviousCandlePayload IsNot Nothing AndAlso
            ...
            Dim signal As Tuple(Of Boolean, Decimal, Integer) = GetSignalForEntry(currentTick)
            If signal IsNot Nothing AndAlso signal.Item1 Then
                ...
                Dim parameter As PlaceOrderParameters = New PlaceOrderParameters With {
                                                            ...
                                                            .Buffer = 0,
                                                            .SignalCandle = currentDayPayload,
    ...
    Private Function GetSignalForEntry(ByVal currentTick As Payload) As Tuple(Of Boolean, Decimal, Integer)
        ...
        Dim rsi As Decimal = _rsiPayloads(currentDayPayload.PayloadDate)
        If rsi <= _userInputs.BuyAtBelowRSI Then
            Dim potentialEntry As Decimal = ConvertFloorCeling(currentDayPayload.Close, _parentStrategy.TickSize, RoundOfType.Floor)
            ...
            If lastOrder Is Nothing OrElse potentialEntry >= lastOrder.EntryPrice Then
                ret = New Tuple(Of Boolean, Decimal, Integer)(True, potentialEntry, initialQuantity)
            ElseIf lastOrder IsNot Nothing AndAlso potentialEntry < lastOrder.EntryPrice Then
                ...
                End Select
                ret = New Tuple(Of Boolean, Decimal, Integer)(True, potentialEntry, quantity)
            Else
                Throw New NotImplementedException
            End If
        End If
