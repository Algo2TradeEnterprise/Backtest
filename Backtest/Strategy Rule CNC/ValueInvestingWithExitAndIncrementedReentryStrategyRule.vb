        ...
        If currentDayCandlePayload IsNot Nothing Then
            ...
            If activeTrades IsNot Nothing AndAlso activeTrades.Count > 0 Then   'Continue Investing
                ...
                Dim numberOfDays As Integer = _signalPayload.Where(Function(x)
                                                                   ...
                                                                   End Function).Count
                Dim desiredValue As Decimal = _userInputs.InitialInvestment + lastTrade.Supporting5 + (numberOfDays - 1) * (_userInputs.InitialInvestment * _userInputs.PercentageOfIncreaseDesireEachPeriod / 100)
