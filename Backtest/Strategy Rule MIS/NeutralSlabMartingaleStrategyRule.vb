...
Public Class NeutralSlabMartingaleStrategyRule
    ...
    Public Overrides Async Function IsTriggerReceivedForPlaceOrderAsync(currentTick As Payload) As Task(Of Tuple(Of Boolean, List(Of PlaceOrderParameters)))
        ...
        If currentMinuteCandlePayload IsNot Nothing AndAlso currentMinuteCandlePayload.PreviousCandlePayload IsNot Nothing AndAlso
            ...
            If signalCandle IsNot Nothing Then
                ...
                Dim tradeNumber As Integer = _parentStrategy.StockNumberOfTrades(_tradingDate, _tradingSymbol)
                Dim loss As Decimal = Math.Pow(2, tradeNumber) * _userInputs.MaxLossPerTrade
                Dim profit As Decimal = Math.Abs(_parentStrategy.StockPLAfterBrokerage(_tradingDate, _tradingSymbol)) + _userInputs.MaxProfitPerTrade
                ...
                If signal.Item4 = Trade.TradeExecutionDirection.Buy Then
                    ...
                    Dim quantity As Integer = _parentStrategy.CalculateQuantityFromTargetSL(_tradingSymbol, entryPrice, stoploss, loss, Trade.TypeOfStock.Cash)
                    Dim target As Decimal = _parentStrategy.CalculatorTargetOrStoploss(_tradingSymbol, entryPrice, quantity, profit, Trade.TradeExecutionDirection.Buy, Trade.TypeOfStock.Cash)
                ...
                ElseIf signal.Item4 = Trade.TradeExecutionDirection.Sell Then
                    ...
                    Dim quantity As Integer = _parentStrategy.CalculateQuantityFromTargetSL(_tradingSymbol, stoploss, entryPrice, loss, Trade.TypeOfStock.Cash)
                    Dim target As Decimal = _parentStrategy.CalculatorTargetOrStoploss(_tradingSymbol, entryPrice, quantity, profit, Trade.TradeExecutionDirection.Sell, Trade.TypeOfStock.Cash)
