...
Public Class MomentumReversalModifiedStrategyRule
        ...
        If currentMinuteCandlePayload IsNot Nothing AndAlso currentMinuteCandlePayload.PreviousCandlePayload IsNot Nothing AndAlso
            ...
            If signalCandle IsNot Nothing Then
                ...
                If signal.Item4 = Trade.TradeExecutionDirection.Buy Then
                    ...
                    If signalCandle.CandleWicks.Top > atr / 2 Then
                        If signalCandle.CandleColor = Color.Green Then
                            stoploss = signalCandle.Close - buffer
                            slRemark = "Wick"
                        Else
                            stoploss = signalCandle.Open - buffer
                            slRemark = "Wick"
                        End If
                    End If
                ...
                ElseIf signal.Item4 = Trade.TradeExecutionDirection.Sell Then
                    ...
                    Dim slRemark As String = "CR"
                    If signalCandle.CandleWicks.Bottom > atr / 2 Then
        ...
        If currentTrade IsNot Nothing AndAlso currentTrade.TradeCurrentStatus = Trade.TradeExecutionStatus.Open Then
            ...
            If ret Is Nothing Then
                If currentTrade.EntryDirection = Trade.TradeExecutionDirection.Buy AndAlso
                    currentMinuteCandlePayload.PreviousCandlePayload.PayloadDate <> currentTrade.SignalCandle.PayloadDate AndAlso
                    currentMinuteCandlePayload.PreviousCandlePayload.Low <= currentTrade.SignalCandle.Low Then
                    ret = New Tuple(Of Boolean, String)(True, "Invalid Signal")
                ElseIf currentTrade.EntryDirection = Trade.TradeExecutionDirection.Sell AndAlso
                    currentMinuteCandlePayload.PreviousCandlePayload.PayloadDate <> currentTrade.SignalCandle.PayloadDate AndAlso
                    currentMinuteCandlePayload.PreviousCandlePayload.High >= currentTrade.SignalCandle.High Then
                    ret = New Tuple(Of Boolean, String)(True, "Invalid Signal")
                End If
            End If
        End If
