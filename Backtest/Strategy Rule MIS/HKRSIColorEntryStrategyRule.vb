...
Public Class HKRSIColorEntryStrategyRule
    ...
    Private Function GetEntrySignal(ByVal currentCandle As Payload, ByVal currentTick As Payload) As Tuple(Of Boolean, Decimal, Payload, Trade.TradeExecutionDirection, String)
        ...
        If currentCandle IsNot Nothing AndAlso currentCandle.PreviousCandlePayload IsNot Nothing Then
            ...
            If _direction = Trade.TradeExecutionDirection.None Then
                Dim rsiDirection As Trade.TradeExecutionDirection = GetRSIDirection(hkCandle)
                If rsiDirection = Trade.TradeExecutionDirection.Buy AndAlso hkCandle.CandleColor = Color.Green Then
                    Dim remark As String = ""
                    If hkCandle.PreviousCandlePayload.CandleColor = Color.Green Then remark = "Same"
                    Dim buyLevel As Decimal = currentTick.Open
                    ret = New Tuple(Of Boolean, Decimal, Payload, Trade.TradeExecutionDirection, String)(True, buyLevel, hkCandle, Trade.TradeExecutionDirection.Buy, remark)
                ElseIf rsiDirection = Trade.TradeExecutionDirection.Sell AndAlso hkCandle.CandleColor = Color.Red Then
                    Dim remark As String = ""
                    If hkCandle.PreviousCandlePayload.CandleColor = Color.Red Then remark = "Same"
                    Dim sellLevel As Decimal = currentTick.Open
                    ret = New Tuple(Of Boolean, Decimal, Payload, Trade.TradeExecutionDirection, String)(True, sellLevel, hkCandle, Trade.TradeExecutionDirection.Sell, remark)
                End If
            Else
    ...
    Private Function GetRSIDirection(ByVal signalCandle As Payload) As Trade.TradeExecutionDirection
