...
Public Class HKUntouchVWAPAdaptiveMartingaleStrategyRule
...
#End Region
    ...
    Public Overrides Async Function IsTriggerReceivedForExitOrderAsync(currentTick As Payload, currentTrade As Trade) As Task(Of Tuple(Of Boolean, String))
        ...
        ElseIf currentTrade IsNot Nothing AndAlso currentTrade.TradeCurrentStatus = Trade.TradeExecutionStatus.Inprogress Then
            Dim currentMinuteCandle As Payload = _signalPayload(_parentStrategy.GetCurrentXMinuteCandleTime(currentTick.PayloadDate, _signalPayload))
            Dim direction As Trade.TradeExecutionDirection = GetDirection(currentMinuteCandle.PreviousCandlePayload)
            If currentTrade.EntryDirection <> direction Then
                ret = New Tuple(Of Boolean, String)(True, "Opposite Signal")
            End If
        End If
        Return ret
    End Function
        ...
        If currentCandle IsNot Nothing AndAlso currentCandle.PreviousCandlePayload IsNot Nothing Then
            ...
            If direction = Trade.TradeExecutionDirection.Buy Then
                If signalCandle.CandleColor = Color.Red Then
                    ...
                    If entryPrice = Math.Round(signalCandle.High, 2) Then
            ...
            ElseIf direction = Trade.TradeExecutionDirection.Sell Then
                If signalCandle.CandleColor = Color.Green Then
                    ...
                    If entryPrice = Math.Round(signalCandle.Low, 2) Then
                        entryPrice = entryPrice - _parentStrategy.CalculateBuffer(entryPrice, RoundOfType.Floor)
                    End If
