...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbRule.Items.AddRange(New Object() {"Reversal HHLL Breakout", "Fractal Trend Line", "Market Plus Market Minus", "Highest Lowest Point", "Heikenashi Reverse Slab", "EMA Scalping", "Supertrend Cut Reversal", "BNF Martingale Strategy", "HigherLow LowerHigh Breakout", "Always in Trade Martingale Strategy", "Martingale Strategy", "Anchor Satellite HK Strategy", "Small Opening Range Breakout", "Loss Makeup Favourable Fractal Breakout", "HK Reverse Slab Martingale Strategy", "Low Price Option Buy Only Strategy", "Low Price Option OI Change Buy Only Strategy", "Lower Price Option Buy Only EOD Strategy", "Every Minute Top Gainer Losser HK Reversal Strategy", "Loss Makeup Rainbow Strategy", "Anchor Satellite Loss Makeup Strategy"})
