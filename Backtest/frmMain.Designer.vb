...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbRule.Items.AddRange(New Object() {"Pivot Trend Option Buy Mode 3 Strategy", "Pivot Trend Option Buy Mode 2 Strategy", "Pivot Trend Option Buy Mode All Strategy"})
