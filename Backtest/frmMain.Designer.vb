...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbRule.Items.AddRange(New Object() {"Pivot Trend Option Buy Mode 3 Strategy", "HK MA Trend Option Buy Mode 3 Strategy", "Central Pivot Trend Option Buy Mode 3 Strategy", "HK Keltner Trend Option Buy Mode 3 Strategy", "Ichimoku Trend Option Buy Mode 3 Strategy"})
