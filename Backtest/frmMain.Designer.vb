...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbRule.Items.AddRange(New Object() {"At Previous Day Swing Low CNC Strategy", "At Previous Day Swing High CNC Strategy", "Below Fractal Low Single Trade CNC Strategy", "Below Fractal Low Multi Trade CNC Strategy"})
