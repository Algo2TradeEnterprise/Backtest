...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbRule.Items.AddRange(New Object() {"Favourable HL/Highest Lowest Point Entry", "ATR Distance From Highest Lowest Point Entry", "Bollinger Touch Favourable Breakout"})
