...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbRule.Items.AddRange(New Object() {"Change Percentage", "Difference", "Difference Bollinger", "Nifty-Banknifty Pair", "Pair Anchor Satellite Loss Makeup HK Strategy", "Pair Difference Percentage HK Strategy", "Change Percentage With Adjustment"})
