...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbRule.Items.AddRange(New Object() {"HK Reversal", "HK RSI", "HK RSI Color Entry", "HK RSI Color Retracement Entry", "Opening Slab Breakout", "Favourable Fractal Breakout"})
