...
#End Region
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If cmbRule.Items.Count > My.Settings.Rule Then cmbRule.SelectedIndex = My.Settings.Rule
    ...
    Private Async Function ViewDataMISAsync() As Task
        Try
            ...
            Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                                              ...
                                                              lastTradeEntryTime:=TimeSpan.Parse("22:30:59"),
                                                              eodExitTime:=TimeSpan.Parse("23:00:00"),
                                                              tickSize:=tick,
                ...
                Dim ruleData As NikhilKumarStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                Dim filename As String = String.Format("Nikhil Backtest Output")
