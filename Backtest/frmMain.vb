    ...
    Private Async Function ViewDataMISAsync() As Task
        ...
        Try
            ...
            Select Case ruleNumber
                Case 0
#Region "Nikhil Crude Oil Strategy"
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                                                    ...
                                                                    tradeStartTime:=TimeSpan.Parse("10:00:00"),
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New NikhilCrudeOilStrategy.StrategyRuleEntities With
                                            {
                                                .Buffer = 5,
                                                .TargetPoint = 5,
                                                .StoplossPoint = 10,
                        ...
                        Dim filename As String = String.Format("CrudeOilHourlyStrategy")
