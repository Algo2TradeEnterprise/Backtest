...
#Region "Anchor Satellite Loss Makeup Strategy"
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        Dim filename As String = String.Format("Anchor Satellite Loss Makeup")
                                ...
                                Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                    ...
                                    With backtestStrategy
                                        ...
                                        .RuleEntityData = New AnchorSatelliteLossMakeupHKStrategyRule.StrategyRuleEntities With
                                            {.ATRMultiplier = atrMul, .FirstTradeMarketEntry = frstTrdMktEntry, .ReEntryAfterHalfATR = hlfATREntry}
                                    ...
                                    Dim filename As String = String.Format("Anchor Satellite Loss Makeup HK,ATRMul {0},FrstTrdMktEntry {1},HlfAtrNtry {2}",
                                                                           ruleData.ATRMultiplier, ruleData.FirstTradeMarketEntry, ruleData.ReEntryAfterHalfATR)
