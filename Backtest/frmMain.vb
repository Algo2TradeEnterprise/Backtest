    ...
    Private Async Function ViewDataMISAsync() As Task
        ...
        Try
            ...
            Select Case ruleNumber
                Case 0
#Region "Retracement Sell Only Strategy"
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            .StockFileName = Path.Combine(My.Application.Info.DirectoryPath, "Strong Moved Stocks.csv")
                            ...
                            .RuleEntityData = New RetracementSellOnlyStrategy.StrategyRuleEntities With
                                            {
                                                .CandleBobyPercentage = 0.5,
                                                .Capital = 5000,
                                                .StoplossTrailingPercentage = 0.5,
                                                .SignalStartTime = New Date(Now.Year, Now.Month, Now.Day, 9, 30, 0),
                                                .SignalEndTime = New Date(Now.Year, Now.Month, Now.Day, 10, 30, 0)
                                            }
                        ...
                        Dim ruleData As RetracementSellOnlyStrategy.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("Retracement Sell")
