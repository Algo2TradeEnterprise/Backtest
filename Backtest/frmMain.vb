...
#End Region
                Case 60
#Region "HK Reversal Adaptive Martingale With Direction Strategy 1"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New HKReversalAdaptiveMartingaleWithDirectionStrategyRule1.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .MaxProfitPerTrade = 500,
                        ...
                        Dim ruleData As HKReversalAdaptiveMartingaleWithDirectionStrategyRule1.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("HKRvslAdptvMrtngl")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 61
#Region "Anchored VWAP Direction Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            .StockFileName = Path.Combine(My.Application.Info.DirectoryPath, "Pre Market Stock Quantity Sort.csv")
                            ...
                            .RuleEntityData = New AnchoredVWAPDirectionStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .TargetMultiplier = 2,
                                                .ATRMultiplier = 2
                        ...
                        Dim ruleData As AnchoredVWAPDirectionStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("AnchrdVWAPDrctnStrgy")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 62
#Region "HK Reversal Adaptive Martingale With Direction Strategy 2"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New HKReversalAdaptiveMartingaleWithDirectionStrategyRule2.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .MaxProfitPerTrade = 500
                                            }
                        ...
                        Dim ruleData As HKReversalAdaptiveMartingaleWithDirectionStrategyRule2.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("HKRvslAdptvMrtngl2")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 63
#Region "Favourable Candle Breakout After V Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New FavourableCandleBreakoutAfterVStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500
                                            }
                        ...
                        Dim ruleData As FavourableCandleBreakoutAfterVStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("FvrblCndlBrkotAftrV")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 64
#Region "HK Forward Breakout Adaptive Martingale Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New HKForwardBreakoutAdaptiveMartingaleStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .MaxProfitPerTrade = 500,
                                                .MaxCapitalPerTrade = 10000000
                                            }
                        ...
                        Dim ruleData As HKForwardBreakoutAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("HK Frwrd Brkot Adptv Mrtngl")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 65
#Region "Favourable Fractal Previous Level Breakout Adaptive Martingale Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New FravourableFractalPreviousLevelBreakoutAdaptiveMartingaleStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .MaxProfitPerTrade = 500
                                            }
                        ...
                        Dim ruleData As FravourableFractalPreviousLevelBreakoutAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("Fvrl Frctl Prv Lvl Brkot Adptv Mrtngl")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 66
#Region "Untouch VWAP Adaptive Martingale Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New UntouchVWAPAdaptiveMartingaleStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .MaxProfitPerTrade = 500
                                            }
                        ...
                        Dim ruleData As UntouchVWAPAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("Untch VWAP Adptv Mrtngl")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 67
#Region "HK Untouch VWAP Adaptive Martingale Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New HKUntouchVWAPAdaptiveMartingaleStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .MaxProfitPerTrade = 500
                                            }
                        ...
                        Dim ruleData As HKUntouchVWAPAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("HK Untch VWAP Adptv Mrtngl")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 68
#Region "Single Trade Risk Reward Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    For tgtMul As Decimal = 2 To 5
                        Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                            ...
                            With backtestStrategy
                                ...
                                .RuleEntityData = New SingleTradeRiskRewardStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .SignalTimeframe = 5,
                                                .ATRMultiplier = 2,
                            ...
                            Dim ruleData As SingleTradeRiskRewardStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                            Dim filename As String = String.Format("SnglTrdRskRwrd,TgtMul {0}", ruleData.TargetMultiplier)
...
#Region "Direction Based"
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New MADirectionBasedStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .ATRMultiplier = 1
                                            }
                        ...
                        Dim ruleData As MADirectionBasedStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("MADrctnBsd")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 70
#Region "EMA Direction Based Hammer Candle Breakout Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                                                    ...
                                                                    exchangeEndTime:=TimeSpan.Parse("15:29:59"),
                                                                    tradeStartTime:=TimeSpan.Parse("9:16:00"),
                                                                    lastTradeEntryTime:=TimeSpan.Parse("14:00:00"),
                                                                    eodExitTime:=TimeSpan.Parse("15:15:00"),
                                                                    tickSize:=tick,
                                                                    marginMultiplier:=margin,
                                                                    timeframe:=15,
                        ...
                        With backtestStrategy
                            .StockFileName = Path.Combine(My.Application.Info.DirectoryPath, "EOD Outside EMA Stocks.csv")
                            ...
                            .RuleEntityData = New EMADirectionBasedHammerCandleBreakoutStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .TargetMultiplier = 2
                                            }
                        ...
                        Dim ruleData As EMADirectionBasedHammerCandleBreakoutStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("EMA Direction Based Hammer Candle Breakout Strategy")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 71
#Region "First Favourable Fractal Top Gainer Looser Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            .StockFileName = Path.Combine(My.Application.Info.DirectoryPath, "First Favourable Fractal Top Gainer Looser Stocks.csv")
                            ...
                            .RuleEntityData = New FirstFavourableFractalTopGainerLooserStrategyRule.StrategyRuleEntities With
                                            {
                                                .MaxLossPerTrade = -500,
                                                .MaxProfitPerTrade = 1000
                                            }
                        ...
                        Dim ruleData As FirstFavourableFractalTopGainerLooserStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("First Favourable Fractal Top Gainer Looser Strategy")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 72
#Region "Diamond Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        Dim ruleData As DiamondStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("Diamond Strategy Output")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 73
#Region "AOL Opening Candle Breakout"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Futures
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New AOLOpeningCandleBreakoutStrategyRule.StrategyRuleEntities With
                        ...
                        Dim ruleData As AOLOpeningCandleBreakoutStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("AOL Opening Candle Breakout Strategy Output")
...
#End Region
                Case 76
#Region "Low Range First Candle Breakout Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    For tgtMul As Decimal = 3 To 5 Step 1
                        For brkvnMul As Decimal = 0.5 To 1 Step 0.5
                            For rvrs As Integer = 0 To 1 Step 1
                                Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                                                                 exchangeStartTime:=TimeSpan.Parse("09:15:00"),
                                                                                 exchangeEndTime:=TimeSpan.Parse("15:29:59"),
                                    ...
                                    With backtestStrategy
                                        .StockFileName = Path.Combine(My.Application.Info.DirectoryPath, "Low Range ATR Stocks.csv")
                                    ...
                                    Dim ruleData As LowRangeFirstCandleBreakoutStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                                    Dim filename As String = String.Format("LwRngFrstCndlBrkot,Tgt {0},Brkevn {1},Rvrs {2}", ruleData.TargetMultiplier, ruleData.BreakevenMultiplier, ruleData.ReverseSignalEntry)
...
#End Region
                Case 77
#Region "Low Range First Candle Gap Breakout Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                        ...
                        For brkvnMul As Decimal = 0.5 To 1 Step 0.5
                            Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                ...
                                With backtestStrategy
                                    ...
                                    .RuleEntityData = New LowRangeFirstCandleBreakoutGapStrategyRule.StrategyRuleEntities With
                                                      {.StoplossPerTrade = -500,
                                                       .TargetMultiplier = tgtMul,
                                                       .BreakevenMultiplier = brkvnMul}
                                ...
                                Dim ruleData As LowRangeFirstCandleBreakoutGapStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                                Dim filename As String = String.Format("LwRngFrstCndlGapBrkot,Tgt {0},Brkevn {1}", ruleData.TargetMultiplier, ruleData.BreakevenMultiplier)
