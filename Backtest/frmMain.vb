        ...
        Try
            ...
            Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                ...
                With backtestStrategy
                    .StockFileName = Path.Combine(My.Application.Info.DirectoryPath, "Rohit Stocklist.csv")
                    ...
                    .RuleEntityData = New RohitStrategyRule.StrategyRuleEntities With
                        {
                            .TraillingStoploss = True,
                            .TraillingStoplossPercentage = 60,
                            .CCILowerCircuit = -100,
                            .CCIUpperCircuit = 100,
                            .MACDLowerCircuit = 0,
                            .MACDUpperCircuit = 0,
