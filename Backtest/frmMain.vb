...
#Region "Pair Change Percent Strategy Rule"
            ...
            '    Dim filename As String = String.Format("Pair Change Percent Output")
...
#Region "Pair Difference % HK Strategy Rule"
            'Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
            '                                                  exchangeStartTime:=TimeSpan.Parse("09:15:00"),
            '                                                  exchangeEndTime:=TimeSpan.Parse("15:29:59"),
            '                                                  tradeStartTime:=TimeSpan.Parse("9:16:00"),
            ...
            '    'Dim ruleData As FavourableFractalBreakoutStrategyRule2.StrategyRuleEntities = backtestStrategy.RuleEntityData
            '    Dim filename As String = String.Format("Pair Diff per HK Output")

            '    Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
            'End Using
#End Region

#Region "Pair Change Percent Strategy Rule With Adjustment"
            'Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
            '                                                  exchangeStartTime:=TimeSpan.Parse("09:15:00"),
            '                                                  exchangeEndTime:=TimeSpan.Parse("15:29:59"),
            '                                                  tradeStartTime:=TimeSpan.Parse("9:16:00"),
            ...
            '    'Dim ruleData As FavourableFractalBreakoutStrategyRule2.StrategyRuleEntities = backtestStrategy.RuleEntityData
            '    Dim filename As String = String.Format("Pair Change Percent With Adjustment Output")
...
#Region "Pair Change Percent Strategy Rule With Adjustment"
            Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                ...
                Dim filename As String = String.Format("Pivot Direction Based Output")
