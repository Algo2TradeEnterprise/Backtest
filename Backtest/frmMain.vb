...
#Region "HK Reversal Strategy"
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        Dim filename As String = String.Format("HK Reversal")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 1
#Region "HK RSI Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        'Dim ruleData As HKReversalAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("HK RSI")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 2
#Region "HK RSI Color Entry Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        'Dim ruleData As HKReversalAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("HK RSI Color Entry")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 3
#Region "HK RSI Color Retracement Entry Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        'Dim ruleData As HKReversalAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("HK RSI Retracement Color Entry")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 4
#Region "Opening Slab Breakout Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    For slabMul As Integer = 1 To 2
                        For slMul As Integer = 1 To 2
                            For tgtMul As Integer = 1 To 2
                                Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                                                    exchangeStartTime:=TimeSpan.Parse("09:15:00"),
                                                                    exchangeEndTime:=TimeSpan.Parse("15:29:59"),
                                    ...
                                    With backtestStrategy
                                        ...
                                        .RuleEntityData = New OpeningSlabBreakoutStrategyRule.StrategyRuleEntities With
                                                                {
                                                                    .StoplossMultiplier = slMul,
                                                                    .TargetMultiplier = tgtMul,
                                                                    .SlabMultiplier = slabMul
                                                                }
                                    ...
                                    'Dim ruleData As HKReversalAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                                    Dim filename As String = String.Format("Opening Slab Breakout,Slb {0},Sl {1},Tgt {2}", slabMul, slMul, tgtMul)
...
#End Region
                Case 5
#Region "Favourable Fractal Breakout Strategy"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        'Dim ruleData As HKReversalAdaptiveMartingaleStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("Favourable Fractal Breakout")
