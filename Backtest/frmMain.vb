                        ...
                        For spotMaxLossPer As Decimal = 0.7 To 0.7 Step 0.1
                            For reversal As Integer = 1 To 1 Step 1
                                Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                    ...
                                    Dim ruleData As AjitJhaOptionStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                                    Dim filename As String = String.Format("AJOptnOtpt,TF {0},SpotMaxLossPer {1},Reversal {2}",
                                                                           backtestStrategy.SignalTimeFrame, ruleData.SpotMaxStoplossPercentage, ruleData.ReverseSignalExit)
...
#Region "Ajit Jha ORB Option Strategy"
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                                                                    exchangeStartTime:=TimeSpan.Parse("09:15:00"),
                                                                    exchangeEndTime:=TimeSpan.Parse("15:29:59"),
                                                                    tradeStartTime:=TimeSpan.Parse("9:55:00"),
                                                                    lastTradeEntryTime:=TimeSpan.Parse("14:54:59"),
                                                                    eodExitTime:=TimeSpan.Parse("15:15:00"),
                                                                    tickSize:=tick,
                                                                    marginMultiplier:=margin,
                                                                    timeframe:=10,
                        ...
                        Dim ruleData As AjitJhaORBOptionStrategyRule.StrategyRuleEntities = backtestStrategy.RuleEntityData
                        Dim filename As String = String.Format("ORB Option Output")
