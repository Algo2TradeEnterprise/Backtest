    ...
    Private Async Function ViewDataMISAsync() As Task
        ...
        Try
            ...
            Select Case ruleNumber
                Case 0
#Region "Favourable HL/HighestLowest Point Entry"
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New MathematicalStrategyRule.StrategyRuleEntities With
                                                  {.TargetType = MathematicalStrategyRule.TypeOfTarget.INR,
                                                   .TargetMultiplier = 1,
                                                   .StoplossMovementType = MathematicalStrategyRule.TypeOfStoplossMovement.MaximizeRiskReward,
                                                   .BreakevenTargetMultiplier = 1}
                        ...
                        Dim filename As String = String.Format("Favourable HL_HighestLowest Point Entry")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 1
#Region "ATR Distance From Highest Lowest Point Entry"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        With backtestStrategy
                            ...
                            .RuleEntityData = New MathematicalStrategyRule.StrategyRuleEntities With
                                                  {.TargetType = MathematicalStrategyRule.TypeOfTarget.INR,
                                                   .TargetMultiplier = 1,
                                                   .StoplossMovementType = MathematicalStrategyRule.TypeOfStoplossMovement.None,
                                                   .BreakevenTargetMultiplier = 1}
                        ...
                        Dim filename As String = String.Format("ATR Distance From Highest Lowest Point Entry")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 2
#Region "Bollinger Touch Favourable Breakout"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        Dim filename As String = String.Format("Bollinger Touch Favourable Breakout")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 3
#Region "Stock & Nifty Trend HK Breakout"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        Dim filename As String = String.Format("Stock_Nifty Trend HK Breakout")

                        Await backtestStrategy.TestStrategyAsync(startDate, endDate, filename).ConfigureAwait(False)
                    End Using
#End Region
                Case 4
#Region "Stock & Nifty Trend VWAP"
                    Dim stockType As Trade.TypeOfStock = Trade.TypeOfStock.Cash
                    Dim database As Common.DataBaseTable = Common.DataBaseTable.None
                    Dim margin As Decimal = 0
                    Dim tick As Decimal = 0
                    ...
                    Using backtestStrategy As New MISGenericStrategy(canceller:=_canceller,
                        ...
                        Dim filename As String = String.Format("Stock_Nifty Trend VWAP")
