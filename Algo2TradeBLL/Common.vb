    ...
    Public Shared Function ConvertDataTableToPayload(ByVal dt As DataTable,
        ...
        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            While Not i = dt.Rows.Count()
                ...
                tempPayload.Low = Math.Min(dt.Rows(i).Item(lowColumnIndex), dt.Rows(i).Item(openColumnIndex))
                tempPayload.High = Math.Max(dt.Rows(i).Item(highColumnIndex), dt.Rows(i).Item(openColumnIndex))
